...
ActiveRecord::Schema.define(version: 2019_07_30_163332) do
  ...
  create_table "biography_events", id: :serial, force: :cascade do |t|
  ...
  create_table "biography_events_person_tags", id: :serial, force: :cascade do |t|
    t.integer "biography_event_id"
    t.integer "person_tag_id"
  end

  create_table "biography_events_type_tags", id: :serial, force: :cascade do |t|
    t.integer "biography_event_id"
  ...
  create_table "person_tags", id: :serial, force: :cascade do |t|
    t.string "name"
  end
  ...
  create_table "type_tags", id: :serial, force: :cascade do |t|
    t.string "name"
  end
